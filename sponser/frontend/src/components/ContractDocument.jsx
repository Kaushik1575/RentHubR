    ...
    return (
        ...
        >
            ...
            <div style={{ position: 'absolute', top: '42%', left: '50%', transform: 'translate(-50%, -50%) rotate(-25deg)', pointerEvents: 'none', zIndex: 0, opacity: 0.03, textAlign: 'center' }}>
                <div style={{ fontSize: '130px', fontWeight: 900, color: '#0f172a', letterSpacing: '4px' }}>RH</div>
                <div style={{ fontSize: '46px', fontWeight: 800, color: '#0f172a', letterSpacing: '6px' }}>RENTHUB</div>
            </div>

            <div style={{ position: 'relative', zIndex: 1 }}>
                {/* 1. TOP HEADER SECTION */}
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #0284c7', paddingBottom: '10px', marginBottom: '10px' }}>
                    {/* Brand Logo */}
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: '180px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', lineHeight: 1 }}>
                            <span style={{ fontSize: '34px', fontWeight: 900, color: '#0f172a', letterSpacing: '-2px', fontFamily: 'system-ui, sans-serif' }}>R</span>
                            <span style={{ fontSize: '34px', fontWeight: 900, color: '#0284c7', letterSpacing: '-2px', marginLeft: '-2px', fontFamily: 'system-ui, sans-serif' }}>H</span>
                        </div>
                        <div>
                    ...
                    <div style={{ textAlign: 'center', flex: 1, padding: '0 10px' }}>
                        <h1 style={{ margin: 0, fontSize: '16px', fontWeight: 900, color: '#0f172a', letterSpacing: '0.4px', textTransform: 'uppercase', lineHeight: '1.2' }}>
                            VEHICLE SPONSOR PARTNERSHIP AGREEMENT
                        </h1>
                        <div style={{ fontSize: '9px', fontWeight: 700, color: '#0284c7', marginTop: '3px', letterSpacing: '0.2px' }}>
                            — Agreement for Vehicle Listing, Operations & Revenue Sharing —
                        </div>
                    </div>

                    {/* Agreement ID & Date Box */}
                    <div style={{ border: '1.5px solid #bfdbfe', borderRadius: '8px', background: '#f8fbff', padding: '5px 10px', textAlign: 'left', minWidth: '135px' }}>
                ...
                <div style={{ border: '1.5px solid #bfdbfe', borderRadius: '10px', background: '#f8fbff', padding: '8px 14px', display: 'grid', gridTemplateColumns: '1fr 1.15fr', gap: '14px', marginBottom: '8px' }}>
                    {/* Left: RentHub Operator */}
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                        <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: '#2563eb', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ffffff', fontSize: '15px', flexShrink: 0, marginTop: '2px' }}>
                            🏢
                        </div>
                        <div>
                    ...
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', borderLeft: '1px solid #e2e8f0', paddingLeft: '14px' }}>
                        <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: '#16a34a', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ffffff', fontSize: '15px', flexShrink: 0, marginTop: '2px' }}>
                            👤
                        </div>
                        <div style={{ width: '100%', fontSize: '8.5px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '70px 1fr', gap: '2px', alignItems: 'center' }}>
                                ...
                                <span style={{ color: '#0f172a', borderBottom: '1px solid #cbd5e1', paddingBottom: '1px' }}>{sponsorAddress}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '8px', border: '1px solid #cbd5e1', borderRadius: '6px', overflow: 'hidden' }}>
                            <tbody>
                                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                                    <td style={{ padding: '3px 6px', color: '#475569', fontWeight: 600 }}>Rental Tariff (Per Day / Hour)</td>
                                    <td style={{ padding: '3px 6px', textAlign: 'right', fontWeight: 800, color: '#0f172a' }}>₹ {dailyRate.toFixed(2)} (₹{hourlyRate}/hr)</td>
                                </tr>
                                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                                    <td style={{ padding: '3px 6px', color: '#475569', fontWeight: 600 }}>Sponsor Share ({sponsorPercent}%)</td>
                                    <td style={{ padding: '3px 6px', textAlign: 'right', fontWeight: 800, color: '#15803d' }}>{sponsorPercent}% (₹{sponsorHourlyPayout}/hr)</td>
                                </tr>
                                <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                                    <td style={{ padding: '3px 6px', color: '#475569', fontWeight: 600 }}>RentHub Commission ({platformPercent}%)</td>
                                    <td style={{ padding: '3px 6px', textAlign: 'right', fontWeight: 800, color: '#475569' }}>{platformPercent}%</td>
                                </tr>
                ...
                <div style={{ marginBottom: '8px' }}>
                    ...
                    <div style={{ border: '1px solid #bfdbfe', borderRadius: '8px', background: '#f8fbff', padding: '6px 12px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
