                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <button onClick={() => { setShowRegisterModal(false); window.open('http://localhost:5175', '_blank'); }} style={{
                                ...
                                color: 'white', display: 'flex', alignItems: 'center', gap: '15px', position: 'relative', overflow: 'hidden',
                                boxShadow: '0 10px 25px rgba(245, 158, 11, 0.3)', transition: 'transform 0.2s, box-shadow 0.2s'
                            }}
                                onMouseOver={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 15px 30px rgba(245, 158, 11, 0.4)'; }}
